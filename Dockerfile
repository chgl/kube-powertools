...
# kubectl
COPY --from=docker.io/bitnami/kubectl:1.33.0@sha256:0f6b5088710f1c6d2d41f5e19a15663b7fef07d89699247aaaad92975be7eed6 /opt/bitnami/kubectl/bin/kubectl /usr/local/bin/kubectl
...
ARG KYVERNO_CLI_VERSION=1.14.0
