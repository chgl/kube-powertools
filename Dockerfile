...
# kubectl
COPY --from=docker.io/bitnami/kubectl:1.32.1@sha256:49d20448fd06913877158ff07dfa05fc0504946439974214863e1a8ae99bf60f /opt/bitnami/kubectl/bin/kubectl /usr/local/bin/kubectl
...
ARG KYVERNO_CLI_VERSION=1.13.4
