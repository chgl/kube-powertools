...
# kubectl
COPY --from=docker.io/bitnami/kubectl:1.30.0@sha256:b3304501336a48b5f845d0897d6c5252c7b2e4f98a9a6fe1a94a96f92a3a2dc9 /opt/bitnami/kubectl/bin/kubectl /usr/local/bin/kubectl
...
ARG KYVERNO_CLI_VERSION=1.12.1
