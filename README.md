...
```sh
docker run --rm -it -v $PWD:/root/workspace ghcr.io/chgl/kube-powertools:v2.1.27
```

The container image is pushed to these two registries:

- docker.io/chgl/kube-powertools:v2.1.27
- ghcr.io/chgl/kube-powertools:v2.1.27
...
```sh
IMAGE=ghcr.io/chgl/kube-powertools:v2.1.27
