...
```sh
docker run --rm -it -v $PWD:/root/workspace ghcr.io/chgl/kube-powertools:v2.1.26
```

The container image is pushed to these two registries:

- docker.io/chgl/kube-powertools:v2.1.26
- ghcr.io/chgl/kube-powertools:v2.1.26
...
```sh
IMAGE=ghcr.io/chgl/kube-powertools:v2.1.26
