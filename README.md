...
```sh
docker run --rm -it -v $PWD:/root/workspace ghcr.io/chgl/kube-powertools:v2.5.49
```

The container image is pushed to these two registries:

- docker.io/chgl/kube-powertools:v2.5.49
- ghcr.io/chgl/kube-powertools:v2.5.49
...
```sh
IMAGE=ghcr.io/chgl/kube-powertools:v2.5.49
